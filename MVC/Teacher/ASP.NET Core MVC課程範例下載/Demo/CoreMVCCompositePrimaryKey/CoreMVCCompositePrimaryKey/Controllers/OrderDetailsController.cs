...
namespace CompositePrimaryKey.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? OrderId, int? ProductId)
        {
            ...
            var orderDetail = await _context.OrderDetails.FirstOrDefaultAsync(m => m.OrderId == OrderId && m.ProductId == ProductId);
            if (orderDetail == null)
            {
                return NotFound();
            }
        ...
        {
            var orderDetail = await _context.OrderDetails.FindAsync(new object[] { OrderId, ProductId });
