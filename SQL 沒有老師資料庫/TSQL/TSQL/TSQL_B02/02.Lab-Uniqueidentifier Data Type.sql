...
--			GUID : Globally Unique Identifier 全球唯一ID
...
--			SQL Server 中的全域(全球**)唯一識別碼 (GUID) 資料類型會以 uniqueidentifier 資料類型來表示，
...
--UUID intel||AMD 都有一個mac address 
...
--	 UNIQUEIDENTIFIER做主鍵(Primary Key)是一件很方便的事情，在資料合併等操作中有不可替代的優勢   * 一般資料庫不建議作為主鍵
