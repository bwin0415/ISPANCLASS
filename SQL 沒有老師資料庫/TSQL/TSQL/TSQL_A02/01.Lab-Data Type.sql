...
--  執行指令如一般程式語言
declare @x int = 20    --declare 宣告 go是區塊的意思
print @x								-- variable
...
create table Table2  (  
    ...
    NumericColumn numeric(20,6)--AxxxxBxxxx駝峰寫法
); 
select * from Table2
go
...
insert into Table4 values ('better', 'best', 'abcdef', 'hij', 'goodbetterbest', 'abcdefghijk');
select * from Table4
go
